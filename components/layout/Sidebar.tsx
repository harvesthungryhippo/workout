...
import {
  ...
  Download, Upload, Settings, ChevronDown, ChevronRight, Zap, Swords, LayoutGrid, ShieldCheck, Building2, MessageSquare, Gauge, Trophy, Radio,
} from "lucide-react";
  ...
  const allGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/workout/morse",     label: "Morse Code",    icon: Radio },
